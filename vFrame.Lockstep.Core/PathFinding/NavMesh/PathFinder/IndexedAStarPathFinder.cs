...
{
    public class IndexedAStarPathFinder<N> : IPathFinder<N>
    {
        private IIndexedGraph<N> _graph;
        ...
        public IndexedAStarPathFinder(IIndexedGraph<N> graph) : this(graph, false) {
        }
        ...
        protected bool Search(N startNode, N endNode, IHeuristic<N> heuristic) {
        ...
        protected void InitSearch(N startNode, N endNode, IHeuristic<N> heuristic) {
            metrics?.reset();
        ...
        protected void VisitChildren(N endNode, IHeuristic<N> heuristic) {
        ...
        protected void GeneratePath(N startNode, IGraphPath<IConnection<N>> outPath) {
        ...
        protected void GenerateNodePath(N startNode, IGraphPath<N> outPath) {
        ...
        protected void AddToOpenList(NodeRecord<N> nodeRecord, FixedPoint estimatedTotalCost) {
        ...
        public class NodeRecord<N> : Node
        {
            ...
            public IConnection<N> connection;
