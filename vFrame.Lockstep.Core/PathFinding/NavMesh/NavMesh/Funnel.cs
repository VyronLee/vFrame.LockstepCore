...
public class Funnel
{
    public Plane leftPlane = new(); // 左平面，高度为y轴
    public TSVector leftPortal; // 路径左顶点，
    public TSVector pivot = new(); // 漏斗点，路径的起点或拐点
    public Plane rightPlane = new();
    public TSVector rightPortal; // 路径右顶点
