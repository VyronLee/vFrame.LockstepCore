...
{
    private static FixedPoint FLOAT_ROUNDING_ERROR = FixedPoint.Epsilon;

    private static TSVector TMP_VEC_1 = new();
    private static TSVector TMP_VEC_2 = new();
    private static TSVector TMP_VEC_3 = new();
