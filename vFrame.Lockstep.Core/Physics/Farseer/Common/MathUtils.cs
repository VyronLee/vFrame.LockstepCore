...
namespace vFrame.Lockstep.Core.Physics2D
{
    ...
    public struct Mat33
    {
        ...
        public TSVector Solve33(TSVector b) {
            ...
            return new TSVector(det * TSVector.Dot(b, TSVector.Cross(ey, ez)),
                det * TSVector.Dot(ex, TSVector.Cross(b, ez)), det * TSVector.Dot(ex, TSVector.Cross(ey, b)));
        }
        ...
        public void GetInverse22(ref Mat33 M) {
            ...
            M.ex.x = det * d;
            M.ey.x = -det * b;
            M.ex.z = FixedPoint.Zero;
            M.ex.y = -det * c;
            M.ey.y = det * a;
            M.ey.z = FixedPoint.Zero;
            M.ez.x = FixedPoint.Zero;
            M.ez.y = FixedPoint.Zero;
            M.ez.z = FixedPoint.Zero;
        }
    ...
    public struct Rot
    {
        ...
        public void Set(TSVector2 forward) {
            s = forward.y;
            c = forward.x;
        }
    ...
    public struct Transform
    {
        ...
        public void Set(TSVector2 pos, TSVector2 forward) {
            p = pos;
            q.Set(forward);
        }
    }
