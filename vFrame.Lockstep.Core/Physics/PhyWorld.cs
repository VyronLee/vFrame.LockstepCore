...
namespace vFrame.Lockstep.Core.Physics2D
{
    ...
    class PhyRaycastResultCallback
    {
        ...
        private FixedPoint RaycastCallback(Fixture f, TSVector2 p, TSVector2 n, FixedPoint fr) {
            ...
            if (go != null) {
                m_hit.go = go;
                m_hit.point = PhyUtils.PhyVed2ToVec3(p, m_height);
                m_hit.normal = PhyUtils.PhyVed2ToVec3(n);
        ...
        private FixedPoint RaycastAllCallback(Fixture f, TSVector2 p, TSVector2 n, FixedPoint fr) {
            ...
            hitInfo.go = go;
            hitInfo.normal = PhyUtils.PhyVed2ToVec3(n);
            hitInfo.point = PhyUtils.PhyVed2ToVec3(p, m_height);
    ...
    public class PhyWorld
    {
        ...
        public PhyGameObject AddMergeShape(MergeShape mergeShape) {
            ...
            return AddShape(mergeShape.m_name, mergeShape.m_center, mergeShape.m_forward, shape, BodyType.Static,
                mergeShape.m_layer);
        }
        ...
        public bool RayCastAll(List<PhyHitInfo> listResult, TSVector point1, TSVector dir, FixedPoint dist,
            int layerMask) {
            listResult.Clear();
        ...
        public bool RayCast(TSVector2 p1, FixedPoint y, TSVector2 dir2, FixedPoint dist, int layerMask,
            out PhyHitInfo hit) {
            TSVector2 p2 = p1 + dir2 * dist;
        ...
        /// <returns></returns>
        public bool CircleCast(TSVector2 p1, FixedPoint y, FixedPoint radius, TSVector2 dir, FixedPoint dist,
            int layerMask, out PhyHitInfo hit) {
        ...
        public bool CircleCast(TSVector point1, FixedPoint radius, TSVector dir, FixedPoint dist, int layerMask,
            out PhyHitInfo hit) {
            TSVector2 p1 = new TSVector2(point1.x, point1.z);
            TSVector2 dir2 = new TSVector2(dir.x, dir.z);
            dir2.Normalize();
        ...
        private PhyGameObject AddShape(string name, TSVector2 centerPos, TSVector2 forward, Shape shape,
            BodyType bodyType, int layer) {
