...
namespace vFrame.Lockstep.Core.RVO2
{
    /**
    ...
    public class Simulator
    {
         ...
         * this agent.</param>
         */
        public int addAgent(TSVector2 position, FixedPoint neighborDist, int maxNeighbors, FixedPoint timeHorizon, FixedPoint timeHorizonObst, FixedPoint radius, FixedPoint maxSpeed, TSVector2 velocity)
        {
            Agent agent = new Agent(this);
            agent.id_ = ++agentId;
        ...
        /**
         * <summary>Remove a agent from the simulation.</summary>
         *
         */
        public void removeAgent(int agentId) {
            var idx = FindAgentIndex(agentId);
            if (idx >= 0) {
        ...
        /**
         * <summary>Find the index of a agent.</summary>
         */
        private int FindAgentIndex(int agentId) {
            var idx = -1;
            for (var i = 0; i < agents_.Count; ++i) {
        ...
        public FixedPoint doStep()
        {
            if (workers_ == null)
            {
                ...
                for (int block = 0; block < workers_.Length; ++block)
                {
                    ...
                    workers_[block] = new Worker(this,
                        block * getNumAgents() / workers_.Length, (block + 1) * getNumAgents() / workers_.Length,
                        doneEvents_[block]);
                }
            }
        ...
        {
            return agents_[FindAgentIndex(agentNo)].agentNeighbors_[neighborNo].Value.id_;
        }
        ...
        {
            return agents_[FindAgentIndex(agentNo)].maxNeighbors_;
        }
         ...
         * to be retrieved.</param>
         */
        public FixedPoint getAgentMaxSpeed(int agentNo)
        {
            return agents_[FindAgentIndex(agentNo)].maxSpeed_;
        }
         ...
         */
        public FixedPoint getAgentNeighborDist(int agentNo)
        {
            return agents_[FindAgentIndex(agentNo)].neighborDist_;
        }
        ...
        {
            return agents_[FindAgentIndex(agentNo)].agentNeighbors_.Count;
        }
        ...
        {
            return agents_[FindAgentIndex(agentNo)].obstacleNeighbors_.Count;
        }
        ...
        {
            return agents_[FindAgentIndex(agentNo)].obstacleNeighbors_[neighborNo].Value.id_;
        }
        ...
        {
            return agents_[FindAgentIndex(agentNo)].orcaLines_;
        }
        ...
        {
            return agents_[FindAgentIndex(agentNo)].position_;
        }
        ...
        {
            return agents_[FindAgentIndex(agentNo)].prefVelocity_;
        }
         ...
         * retrieved.</param>
         */
        public FixedPoint getAgentRadius(int agentNo)
        {
            return agents_[FindAgentIndex(agentNo)].radius_;
        }
         ...
         * to be retrieved.</param>
         */
        public FixedPoint getAgentTimeHorizon(int agentNo)
        {
            return agents_[FindAgentIndex(agentNo)].timeHorizon_;
        }
         ...
         */
        public FixedPoint getAgentTimeHorizonObst(int agentNo)
        {
            return agents_[FindAgentIndex(agentNo)].timeHorizonObst_;
        }
        ...
        {
            return agents_[FindAgentIndex(agentNo)].velocity_;
        }
         ...
         * </returns>
         */
        public FixedPoint getGlobalTime()
        {
            return globalTime_;
        }
         ...
         */
        public bool queryVisibility(TSVector2 point1, TSVector2 point2, FixedPoint radius)
        {
         ...
         */
        public void setAgentDefaults(FixedPoint neighborDist, int maxNeighbors, FixedPoint timeHorizon, FixedPoint timeHorizonObst, FixedPoint radius, FixedPoint maxSpeed, TSVector2 velocity)
        {
            if (defaultAgent_ == null)
            {
        ...
        {
            agents_[FindAgentIndex(agentNo)].maxNeighbors_ = maxNeighbors;
        }
         ...
         * non-negative.</param>
         */
        public void setAgentMaxSpeed(int agentNo, FixedPoint maxSpeed)
        {
            agents_[FindAgentIndex(agentNo)].maxSpeed_ = maxSpeed;
        }
         ...
         */
        public void setAgentNeighborDist(int agentNo, FixedPoint neighborDist)
        {
            agents_[FindAgentIndex(agentNo)].neighborDist_ = neighborDist;
        }
        ...
        {
            agents_[FindAgentIndex(agentNo)].position_ = position;
        }
        ...
        {
            agents_[FindAgentIndex(agentNo)].prefVelocity_ = prefVelocity;
        }
         ...
         * </param>
         */
        public void setAgentRadius(int agentNo, FixedPoint radius)
        {
            agents_[FindAgentIndex(agentNo)].radius_ = radius;
        }
         ...
         */
        public void setAgentTimeHorizon(int agentNo, FixedPoint timeHorizon)
        {
            agents_[FindAgentIndex(agentNo)].timeHorizon_ = timeHorizon;
        }
         ...
         */
        public void setAgentTimeHorizonObst(int agentNo, FixedPoint timeHorizonObst)
        {
            agents_[FindAgentIndex(agentNo)].timeHorizonObst_ = timeHorizonObst;
        }
        ...
        {
            agents_[FindAgentIndex(agentNo)].velocity_ = velocity;
        }
         ...
         */
        public void setGlobalTime(FixedPoint globalTime)
        {
         ...
         * positive.</param>
         */
        public void setTimeStep(FixedPoint timeStep)
        {
            timeStep_ = timeStep;
        }
         ...
         */
        public Simulator(FixedPoint timeStep) : this() {
            timeStep_ = timeStep;
        }
