...
namespace vFrame.Lockstep.Core.RVO2
{
    ...
    public struct RVOMath
    {
         ...
         */
        internal static readonly FixedPoint RVO_EPSILON = 0.00001f;
         ...
         */
        public static FixedPoint abs(TSVector2 vector)
        {
         ...
         */
        public static FixedPoint absSq(TSVector2 vector)
        {
         ...
         * matrix.</param>
         */
        internal static FixedPoint det(TSVector2 vector1, TSVector2 vector2)
        {
         ...
         * be calculated.</param>
         */
        internal static FixedPoint distSqPointLineSegment(TSVector2 vector1, TSVector2 vector2, TSVector2 vector3)
        {
            FixedPoint r = ((vector3 - vector1) * (vector2 - vector1)) / absSq(vector2 - vector1);
         ...
         * calculated.</param>
         */
        internal static FixedPoint leftOf(TSVector2 a, TSVector2 b, TSVector2 c)
        {
            return det(a - c, b - a);
        }
        ...
        {
            return (FixedPoint)TSMath.Sqrt(scalar);
        }
    }
}
