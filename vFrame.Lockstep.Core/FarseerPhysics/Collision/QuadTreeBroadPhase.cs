...
namespace vFrame.Lockstep.Core.FarseerPhysics.Collision
{
    public class QuadTreeBroadPhase : IBroadPhase
    {
        ...
        private Func<RayCastInput, Element<FixtureProxy>, FixedPoint> TransformRayCallback(
            Func<RayCastInput, int, FixedPoint> callback) {
            Func<RayCastInput, Element<FixtureProxy>, FixedPoint> newCallback =
