...
namespace vFrame.Lockstep.Core.FarseerPhysics.Collision
{
    ...
    internal struct Simplex
    {
        ...
        internal void Solve2() {
            ...
            FixedPoint inv_d12 = 1.0f / (d12_1 + d12_2);
        ...
        internal void Solve3() {
            ...
            if (d13_1 > 0.0f && d13_2 > 0.0f && d123_2 <= 0.0f) {
                FixedPoint inv_d13 = 1.0f / (d13_1 + d13_2);
            ...
            if (d23_1 > 0.0f && d23_2 > 0.0f && d123_1 <= 0.0f) {
                FixedPoint inv_d23 = 1.0f / (d23_1 + d23_2);
            ...
            FixedPoint inv_d123 = 1.0f / (d123_1 + d123_2 + d123_3);
    ...
    public static class Distance
    {
        ...
        public static void ComputeDistance(out DistanceOutput output,
            ...
            TSVector2 closestPoint = simplex.GetClosestPoint();
            FixedPoint distanceSqr1 = closestPoint.LengthSquared();
            FixedPoint distanceSqr2 = distanceSqr1;
            ...
            while (iter < k_maxIters) {
                ...
                TSVector2 p = simplex.GetClosestPoint();
