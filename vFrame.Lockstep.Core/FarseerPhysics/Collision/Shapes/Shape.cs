...
namespace vFrame.Lockstep.Core.FarseerPhysics.Collision.Shapes
{
    ...
    public abstract class Shape
    {
        ...
        internal FixedPoint _density;
        internal FixedPoint _radius;

        protected Shape(FixedPoint density) {
            _density = density;
        ...
        public abstract FixedPoint ComputeSubmergedArea(TSVector2 normal, FixedPoint offset, Transform xf, out TSVector2 sc);
    }
}