...
namespace vFrame.Lockstep.Core.FarseerPhysics.Collision
{
    ...
    public class DynamicTree<T>
    {
        ...
        public void RayCast(Func<RayCastInput, int, FixedPoint> callback, ref RayCastInput input) {
            ...
            TSVector2 absV = MathUtils.Abs(new TSVector2(-r.y, r.x));
            ...
            while (_stack.Count > 0) {
                ...
                FixedPoint separation = TSMath.Abs(TSVector2.Dot(new TSVector2(-r.y, r.x), p1 - c)) - TSVector2.Dot(absV, h);
                if (separation > 0.0f) {
                    continue;
                }
                ...
                if (node.IsLeaf()) {
                    ...
                    FixedPoint value = callback(subInput, nodeId);
        ...
        private void InsertLeaf(int leaf) {
            ...
            while (_nodes[index].IsLeaf() == false) {
                ...
                FixedPoint cost = 2.0f * combinedArea;

                // Minimum cost of pushing the leaf further down the tree
                FixedPoint inheritanceCost = 2.0f * (combinedArea - area);
        ...
        void RebuildBottomUp() {
            ...
            while (count > 1) {
                FixedPoint minCost = Settings.MaxFloat;
                int iMin = -1, jMin = -1;
