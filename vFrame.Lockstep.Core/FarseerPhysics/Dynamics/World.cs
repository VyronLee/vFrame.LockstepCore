...
namespace vFrame.Lockstep.Core.FarseerPhysics.Dynamics
{
    ...
    public class World
    {
        ...
        public FixedPoint UpdateTime { get; private set; }

        public FixedPoint ContinuousPhysicsTime { get; private set; }

        public FixedPoint ControllersUpdateTime { get; private set; }

        public FixedPoint AddRemoveTime { get; private set; }

        public FixedPoint ContactsUpdateTime { get; private set; }

        public FixedPoint SolveUpdateTime { get; private set; }
        ...
        public void Step(FixedPoint dt) {
#if (!SILVERLIGHT)
        ...
        public void RayCast(RayCastCallback callback, TSVector2 point1, TSVector2 point2) {
            ...
            ContactManager.BroadPhase.RayCast((rayCastInput, proxyId) => {
                ...
                if (hit) {
                    ...
                    TSVector2 point = (1.0f - fraction) * input.Point1 +
                ...
                for (int i = 0; i < ContactManager.ContactList.Count; i++) {
                    ...
                    if ((c.Flags & ContactFlags.TOI) == ContactFlags.TOI) {
                        ...
                        bool collideB = (bB.IsBullet || typeB != BodyType.Dynamic) &&
                                        ((fB.IgnoreCCDWith & fA.CollisionCategories) == 0);
                        ...
                        FixedPoint alpha0 = bA.Sweep.Alpha0;
                        ...
                        FixedPoint beta = output.T;
                        if (output.State == TOIOutputState.Touching) {
                            alpha = TSMath.Min(alpha0 + (1.0f - alpha0) * beta, 1.0f);
                        }
                        else {
                            alpha = 1.0f;
                        }
