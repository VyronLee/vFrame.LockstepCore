...
namespace vFrame.Lockstep.Core.FarseerPhysics.Dynamics.Joints
{
    ...
    {
        public FixedPoint AngularA;
        public FixedPoint AngularB;
        public TSVector2 Linear;

        public void SetZero() {
            AngularA = 0.0f;
            Linear = TSVector2.zero;
            AngularB = 0.0f;
        }
    }
    ...
    public abstract class FarseerJoint
    {
        ...
        /// The default value is FixedPoint.MaxValue
        /// </summary>
        public FixedPoint Breakpoint = FixedPoint.MaxValue;
        ...
        /// </summary>
        /// <value></value>
        public abstract TSVector2 WorldAnchorA { get; }
        ...
        /// </summary>
        public event Action<FarseerJoint, FixedPoint> Broke;
        ...
        /// <returns></returns>
        public abstract TSVector2 GetReactionForce(FixedPoint inv_dt);
        ...
        /// <param name="inv_dt">The inv_dt.</param>
        /// <returns></returns>
        public abstract FixedPoint GetReactionTorque(FixedPoint inv_dt);
        ...
        internal void Validate(FixedPoint invDT) {
            if (!Enabled)
                return;

            FixedPoint jointError = GetReactionForce(invDT).magnitude;
            if (TSMath.Abs(jointError) <= Breakpoint)
                return;
