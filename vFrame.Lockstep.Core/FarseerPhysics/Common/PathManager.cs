...
namespace vFrame.Lockstep.Core.FarseerPhysics.Common
{
    ...
    public static class PathManager
    {
        ...
        /// <param name="subdivisions">The subdivisions.</param>
        public static void ConvertPathToPolygon(Path path, Body body, FixedPoint density, int subdivisions) {
            if (!path.Closed)
        ...
        public static void MoveBodyOnPath(Path path, Body body, FixedPoint time, FixedPoint strength, FixedPoint timeStep) {
        ...
        public static List<RevoluteJoint> AttachBodiesWithRevoluteJoint(World world, List<Body> bodies,
            TSVector2 localAnchorA,
            TSVector2 localAnchorB, bool connectFirstAndLast,
        ...
        /// <returns></returns>
        public static List<SliderJoint> AttachBodiesWithSliderJoint(World world, List<Body> bodies,
            TSVector2 localAnchorA,
            TSVector2 localAnchorB, bool connectFirstAndLast,
            bool collideConnected, FixedPoint minLength,
