...
namespace vFrame.Lockstep.Core.FarseerPhysics.Common
{
    ...
    public class WorldXmlSerializer
    {
        ...
        private void WriteElement(string name, TSVector2 vec) {
        ...
        private void WriteElement(string name, FixedPoint val) {
            _writer.WriteElementString(name, val.ToString());
        }
    ...
    public class WorldXmlDeserializer
    {
                        ...
                        switch (type) {
                            ...
                            case ShapeType.Polygon: {
                                ...
                                foreach (XMLFragmentElement sn in n.Elements) {
                                    switch (sn.Name.ToLower()) {
                                        case "vertices": {
                                            List<TSVector2> verts = new List<TSVector2>();
                        ...
                        foreach (XMLFragmentElement sn in n.Elements) {
                            switch (sn.Name.ToLower()) {
                                ...
                                case "linearvelocity":
                                    ...
                                    break;
                                case "position": {
                                    FixedPoint rotation = body.Rotation;
                    ...
                    foreach (XMLFragmentElement n in jointElement.Elements) {
                        ...
                        foreach (XMLFragmentElement sn in n.Elements) {
                            ...
                            switch (type) {
                                ...
                                //                break;
                                //            case "motorspeed":
                                //                ((WheelJoint)joint).MotorSpeed = FixedPoint.Parse(sn.Value);
                                //                break;
                                //            case "dampingratio":
                                //                ((WheelJoint)joint).DampingRatio = FixedPoint.Parse(sn.Value);
                                //                break;
                                //            case "maxmotortorque":
                                //                ((WheelJoint)joint).MaxMotorTorque = FixedPoint.Parse(sn.Value);
                                //                break;
                                //            case "frequencyhz":
                                //                ((WheelJoint)joint).Frequency = FixedPoint.Parse(sn.Value);
                                //                break;
                                //            case "localxaxis":
                                ...
                                //                break;
                                //            case "lengtha":
                                //                ((PulleyJoint)joint).LengthA = FixedPoint.Parse(sn.Value);
                                //                break;
                                //            case "lengthb":
                                //                ((PulleyJoint)joint).LengthB = FixedPoint.Parse(sn.Value);
                                //                break;
                                //            case "localanchora":
                                ...
                                //                break;
                                //            case "maxlengtha":
                                //                ((PulleyJoint)joint).MaxLengthA = FixedPoint.Parse(sn.Value);
                                //                break;
                                //            case "maxlengthb":
                                //                ((PulleyJoint)joint).MaxLengthB = FixedPoint.Parse(sn.Value);
                                //                break;
                                //            case "ratio":
                                //                ((PulleyJoint)joint).Ratio = FixedPoint.Parse(sn.Value);
                                //                break;
                                //        }
                                //    }
                                //    break;
        ...
        private TSVector2 ReadVector(XMLFragmentElement node) {
