...
namespace vFrame.Lockstep.Core.FarseerPhysics.Common.PolygonManipulation
{
    public static class CuttingTools
    {
        ...
        public static void SplitShape(Fixture fixture, TSVector2 entryPoint, TSVector2 exitPoint, FixedPoint splitSize,
        ...
        public static void Cut(World world, TSVector2 start, TSVector2 end, FixedPoint thickness) {
        ...
        private static bool SanityCheck(Vertices vertices) {
            ...
            for (int i = 0; i < vertices.Count; ++i) {
                ...
                for (int j = 0; j < vertices.Count; ++j) {
                    ...
                    TSVector2 r = vertices[j] - vertices[i1];
