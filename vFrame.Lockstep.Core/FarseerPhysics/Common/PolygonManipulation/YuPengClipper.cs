...
namespace vFrame.Lockstep.Core.FarseerPhysics.Common.PolygonManipulation
{
    ...
    {
        private static readonly FixedPoint ClipperEpsilonSquared = 1.192092896e-07f;
        ...
        private static List<Vertices> Execute(Vertices subject, Vertices clip,
            ...
            TSVector2 lbSubject = subject.GetCollisionBox().LowerBound;
            TSVector2 lbClip = clip.GetCollisionBox().LowerBound;
            TSVector2 translate;
