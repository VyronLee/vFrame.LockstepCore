...
namespace vFrame.Lockstep.Core.FarseerPhysics.Controllers
{
    public sealed class BuoyancyController : Controller
    {
        ...
        /// </summary>
        public FixedPoint AngularDragCoefficient;
        ...
        /// simulate water-like fluids.
        /// </summary>
        public FixedPoint LinearDragCoefficient;
        ...
        public BuoyancyController(AABB container, FixedPoint density, FixedPoint linearDragCoefficient,
            FixedPoint rotationalDragCoefficient, TSVector2 gravity)
        ...
        public override void Update(FixedPoint dt) {
            ...
            foreach (KeyValuePair<int, Body> kv in _uniqueBodies) {
                ...
                for (int j = 0; j < body.FixtureList.Count; j++) {
                    ...
                    TSVector2 sc;
                    FixedPoint sarea = shape.ComputeSubmergedArea(_normal, _offset, body.Xf, out sc);
                    area += sarea;
                    areac.x += sarea * sc.x;
                    areac.y += sarea * sc.y;
