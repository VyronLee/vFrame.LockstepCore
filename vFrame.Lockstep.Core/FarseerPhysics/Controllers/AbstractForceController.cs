...
namespace vFrame.Lockstep.Core.FarseerPhysics.Controllers
{
    public abstract class AbstractForceController : Controller
    {
        ...
        /// </summary>
        public FixedPoint MaximumSpeed { get; set; }
        ...
        /// the affected body
        /// </summary>
        public FixedPoint MaximumForce { get; set; }
        ...
        /// </summary>
        public FixedPoint ImpulseTime { get; private set; }

        /// <summary>
        /// Length of a triggered impulse. Used in both Triggered and Curve Mode
        /// </summary>
        public FixedPoint ImpulseLength { get; set; }
        ...
        /// </summary>
        public FixedPoint Variation { get; set; }
        ...
        /// </summary>
        public FixedPoint DecayStart { get; set; }

        /// <summary>
        /// Maximum distance a force should be applied
        /// </summary>
        public FixedPoint DecayEnd { get; set; }
        ...
        protected FixedPoint GetDecayMultiplier(Body body) {
            //TODO: Consider ForceType in distance calculation!
            FixedPoint distance = (body.Position - Position).magnitude;
            switch (DecayMode) {
        ...
        public abstract void ApplyForce(FixedPoint dt, FixedPoint strength);
    }
}