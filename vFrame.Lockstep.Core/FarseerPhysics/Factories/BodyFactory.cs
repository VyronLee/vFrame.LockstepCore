...
namespace vFrame.Lockstep.Core.FarseerPhysics.Factories
{
    public static class BodyFactory
    {
        ...
        public static Body CreateBody(World world, TSVector2 position) {
            return CreateBody(world, position, null);
        }

        public static Body CreateBody(World world, TSVector2 position, object userData) {
            Body body = CreateBody(world, userData);
            body.Position = position;
            return body;
        }

        public static Body CreateEdge(World world, TSVector2 start, TSVector2 end) {
            return CreateEdge(world, start, end, null);
        }

        public static Body CreateEdge(World world, TSVector2 start, TSVector2 end, object userData) {
        ...
        public static Body CreateRectangle(World world, FixedPoint width, FixedPoint height, FixedPoint density) {
            return CreateRectangle(world, width, height, density, null);
        }

        public static Body CreateRectangle(World world, FixedPoint width, FixedPoint height, FixedPoint density, object userData) {
            return CreateRectangle(world, width, height, density, TSVector2.zero, userData);
        }

        public static Body CreateRectangle(World world, FixedPoint width, FixedPoint height, FixedPoint density, TSVector2 position) {
        ...
        public static Body CreateCircle(World world, FixedPoint radius, FixedPoint density) {
            return CreateCircle(world, radius, density, null);
        }

        public static Body CreateCircle(World world, FixedPoint radius, FixedPoint density, object userData) {
            return CreateCircle(world, radius, density, TSVector2.zero, userData);
        }

        public static Body CreateCircle(World world, FixedPoint radius, FixedPoint density, TSVector2 position) {
            return CreateCircle(world, radius, density, position, null);
        }

        public static Body CreateCircle(World world, FixedPoint radius, FixedPoint density, TSVector2 position, object userData) {
            Body body = CreateBody(world, position);
            FixtureFactory.AttachCircle(radius, density, body, userData);
            return body;
        }

        public static Body CreateEllipse(World world, FixedPoint xRadius, FixedPoint yRadius, int edges, FixedPoint density) {
        ...
        public static Body CreateEllipse(World world, FixedPoint xRadius, FixedPoint yRadius, int edges, FixedPoint density,
            TSVector2 position, object userData) {
            Body body = CreateBody(world, position);
            FixtureFactory.AttachEllipse(xRadius, yRadius, edges, density, body, userData);
            return body;
        }

        public static Body CreatePolygon(World world, Vertices vertices, FixedPoint density) {
            return CreatePolygon(world, vertices, density, null);
        }

        public static Body CreatePolygon(World world, Vertices vertices, FixedPoint density, object userData) {
            return CreatePolygon(world, vertices, density, TSVector2.zero, userData);
        }

        public static Body CreatePolygon(World world, Vertices vertices, FixedPoint density, TSVector2 position) {
        ...
        public static Body CreateCompoundPolygon(World world, List<Vertices> list, FixedPoint density) {
        ...
        public static Body CreateGear(World world, FixedPoint radius, int numberOfTeeth, FixedPoint tipPercentage,
            FixedPoint toothHeight, FixedPoint density) {
            return CreateGear(world, radius, numberOfTeeth, tipPercentage, toothHeight, density, null);
        }

        public static Body CreateGear(World world, FixedPoint radius, int numberOfTeeth, FixedPoint tipPercentage,
            FixedPoint toothHeight, FixedPoint density, object userData) {
        ...
        /// <returns></returns>
        public static Body CreateCapsule(World world, FixedPoint height, FixedPoint topRadius, int topEdges,
            FixedPoint bottomRadius,
            int bottomEdges, FixedPoint density, TSVector2 position, object userData) {
        ...
        public static Body CreateCapsule(World world, FixedPoint height, FixedPoint topRadius, int topEdges,
            FixedPoint bottomRadius,
            int bottomEdges, FixedPoint density, TSVector2 position) {
            return CreateCapsule(world, height, topRadius, topEdges, bottomRadius, bottomEdges, density, position,
                null);
        }

        public static Body CreateCapsule(World world, FixedPoint height, FixedPoint endRadius, FixedPoint density) {
        ...
        /// <param name="position">The position.</param>
        /// <returns></returns>
        public static Body CreateRoundedRectangle(World world, FixedPoint width, FixedPoint height, FixedPoint xRadius,
            FixedPoint yRadius,
            int segments, FixedPoint density, TSVector2 position,
            object userData) {
        ...
        public static Body CreateRoundedRectangle(World world, FixedPoint width, FixedPoint height, FixedPoint xRadius,
            FixedPoint yRadius,
            int segments, FixedPoint density) {
            return CreateRoundedRectangle(world, width, height, xRadius, yRadius, segments, density, null);
        }

        public static Body CreateRoundedRectangle(World world, FixedPoint width, FixedPoint height, FixedPoint xRadius,
            FixedPoint yRadius,
            int segments, FixedPoint density, object userData) {
            return CreateRoundedRectangle(world, width, height, xRadius, yRadius, segments, density, TSVector2.zero,
                userData);
        }

        public static BreakableBody CreateBreakableBody(World world, Vertices vertices, FixedPoint density) {
            return CreateBreakableBody(world, vertices, density, null);
        }

        public static BreakableBody
            CreateBreakableBody(World world, Vertices vertices, FixedPoint density, object userData) {
            return CreateBreakableBody(world, vertices, density, TSVector2.zero, userData);
        }
        ...
        public static Body CreateLineArc(World world, FixedPoint radians, int sides, FixedPoint radius, TSVector2 position,
            FixedPoint angle, bool closed) {
            Body body = CreateBody(world);
            FixtureFactory.AttachLineArc(radians, sides, radius, position, angle, closed, body);
            return body;
        }

        public static Body CreateSolidArc(World world, FixedPoint density, FixedPoint radians, int sides, FixedPoint radius,
            TSVector2 position, FixedPoint angle) {
            Body body = CreateBody(world);
