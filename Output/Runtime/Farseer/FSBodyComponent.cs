...
public class FSBodyComponent : MonoBehaviour
{
	...
	public virtual void Start ()
	{
		...
		body.BodyType = Type;
		body.Position = new TSVector2(transform.position.x, transform.position.y);
	...
	void Update ()
	{
		...
		pos.x = (float)body.Position.x;
		pos.y = (float)body.Position.y;
		Vector3 rot = transform.rotation.eulerAngles;
		rot.z = (float)body.Rotation * Mathf.Rad2Deg;
