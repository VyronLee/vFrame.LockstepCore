...
public class FSRevoluteJointComponent : FSJointComponent
{
	...
	{
		LocalAnchorB = value;
		joint.LocalAnchorB = FSHelper.Vector2ToTSVector2(value);
	}
	...
	public override void InitJoint ()
	{
		...
		joint = JointFactory.CreateRevoluteJoint(FSWorldComponent.PhysicsWorld, BodyA.PhysicsBody, BodyB.PhysicsBody,
		 BodyB.PhysicsBody.GetLocalPoint(FSHelper.Vector3ToTSVector2(p0)));
		joint.CollideConnected = CollideConnected;
		joint.LowerLimit = LowerLimit * Mathf.Deg2Rad;
		joint.UpperLimit = UpperLimit * Mathf.Deg2Rad;
		joint.LimitEnabled = LimitEnabled;
